...
def _records_to_rows(records: list[dict]) -> list[dict]:
    ...
    for r in records:
        ...
        rows.append({
            "fecha": fecha,
            "indicaciones": r.get("campos_indicaciones") or "",
            "nombre_o_titulo": r.get("campos_nombre_o_titulo") or "",
            "cargo_dependencia": r.get("campos_cargo_dependencia") or "",
            "direccion": r.get("campos_direccion") or "",
            "colonia": r.get("campos_colonia") or "",
            "municipio_o_alcaldia": r.get("campos_municipio_o_alcaldia") or "",
            "estado": r.get("campos_estado") or "",
            "codigo_postal": r.get("campos_codigo_postal") or "",
            "contacto": r.get("campos_contacto") or "",
            "extras": r.get("campos_extras") or "",
